<?php
	...
	$model->spanishStoreEq = $model->getSpanishStoreEq();
	$model->englishStoreEq = $model->getEnglishStoreEq();
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group no-margin">
                    <label class="control-label"><?= $model->attributeLabels()['spanishStoreEq'] ?></label>
                    <div><?= $form->field($model, 'spanishStoreEq')
							->textInput()
							->label(false) ?></div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group no-margin">
                    <label class="control-label"><?= $model->attributeLabels()['englishStoreEq'] ?></label>
                    <div><?= $form->field($model, 'englishStoreEq')
							->textInput()
							->label(false) ?></div>
                </div>
            </div>

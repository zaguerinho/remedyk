<?php
	...
	/* @var $searchModel common\models\search\ProceduresSearch */
        ...
        <div class="panel panel-head">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    <a href="/procedure/create" role="modal-remote" class="btn btn-xs btn-action"><span><i
                                    class="fa fa-plus"></i></span> <?= Yii::t('app', 'New Procedure') ?></a>

<?php
	...
	use common\models\search\ProceduresSearch;
	...
	/**
	 * ProdudureController implements the CRUD actions for Procedure model.
	 */
	class ProcedureController extends Controller{
				...
				*/
				...
				if($request->isGet){
					...
					return [
						...
						'title'       => "Create new Procedure",
						'content'     => '<span class="text-success">Create Procedure success</span>',
						'footer'      => Html::button('Close',
								['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"])
										 . Html::a('Create More',
								['create'],
		...
		/**
		 * Delete an existing Procedure model.
		 * For ajax request will return json object
		...
		/**
		 * Delete multiple existing Procedure model.
		 * For ajax request will return json object
		 * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
		 *
		 * @param integer $id

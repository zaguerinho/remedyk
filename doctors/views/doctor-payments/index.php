<?php
	...
	/* @var $searchModel doctors\models\search\DoctorPaymentSearch */
...
?>
<div class="doctor-payments-index">
    <div class="panel">
        <div class="panel panel-head">
            <div class="row">
                ...
                <div class="col-xs-9 text-right">
                    <!-- <a href="/doctor-payments/create" role="modal-remote" class="btn btn-xs btn-action"><span><i
                                    class="fa fa-plus"></i></span> <?//= Yii::t('app', 'New Payment') ?></a> -->
